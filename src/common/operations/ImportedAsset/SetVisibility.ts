...
export async function perform(targetAssetKey: string, newVisibilityValue: ImportedAssetVisibility, tokenType: "token" | "nft") {
  return await sendQuery<Data, void>(topic, "internal", { targetAssetKey, newVisibilityValue, tokenType });
}
